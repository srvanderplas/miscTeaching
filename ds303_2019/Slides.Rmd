...
## Fit another model
```{r}
meh_model <- lm(Happiness_Index ~ ., data = select(model_data, -Country, -Gross_National_Income, -matches("bad_model")))
summary(meh_model)
...
---
class: middle, center
## Cross Validation and Model Comparison (in R)
...
```{r, eval = F}
library(tidyverse)
install.packages(c("parsnip", "broom", "yardstick", "tidymodels", "AmesHousing"))
```
